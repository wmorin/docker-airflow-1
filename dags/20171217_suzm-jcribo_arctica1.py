...
args = {
    ...
    'pixel_size': 1.07,
    'cs': 2.7,
    'gain_referenced': False, #True, # if the mrcs are already gain refed
}
...
e2proc2d.py {{ ti.xcom_pull( task_ids='gainref_file' )[0] }} {{ ti.xcom_pull( task_ids='gainref_file' )[0] | replace( '.dm4', '.mrc' ) }}
""",
        )
...
MotionCor2  \
    ...
    -Gain     {{ ti.xcom_pull( task_ids='gainref_file' )[0] | replace( '.dm4', '.mrc' ) }} \
